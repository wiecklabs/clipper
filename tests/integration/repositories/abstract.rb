module Integration::AbstractRepositoryTest
  ...
  def setup_abstract
    ...
    # TODO: add by default
    @repository.class.type_map << Clipper::TypeMap::Signature.new(
      [String],
      [Hsqldb::String],
    ...
    @zoo = Class.new do
      ...
      orm.map(self, "abstract_zoos") do |zoos|
        zoos.field :id, Hsqldb::Serial.new
        zoos.field :name, Hsqldb::String.new(200)
        zoos.field :city, Hsqldb::String.new(200)
        zoos.field :state, Hsqldb::String.new(200)
...
#
    @city = Class.new do
      ...
      orm.map(self, "cities") do |cities|
        cities.field :name, Hsqldb::String.new(200)
        cities.field :state, Hsqldb::String.new(200)
        cities.field :region, Hsqldb::String.new(200)
#        cities.field :capital, Hsqldb::Boolean
    ...
    @person = Class.new do
      ...
      orm.map(self, "people") do |people|
        people.field :id, Hsqldb::Serial.new
        people.field :name, Hsqldb::String.new(200)
        people.field :gpa, Hsqldb::Float.new#(7, 2)
