...
require Pathname(__FILE__).dirname + "orm" + "validations" + "minimum_length_validator"
require Pathname(__FILE__).dirname + "orm" + "validations" + "maximum_length_validator"
require Pathname(__FILE__).dirname + "orm" + "validations" + "within_validator"
require Pathname(__FILE__).dirname + "orm" + "validations" + "size_validator"
require Pathname(__FILE__).dirname + "orm" + "validations" + "required_validator"
require Pathname(__FILE__).dirname + "orm" + "validations" + "format_validator"
